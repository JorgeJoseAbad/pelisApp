...
Variante que usa en login un mock de usuarios guardados en sesionStore
...
```
git clone https://github.com/angular/mis-peliculas.git
cd mis-Peliculas
```
una vez allí basta con ejecutar el comando
